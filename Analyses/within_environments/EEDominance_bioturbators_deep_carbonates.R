...
table(all_deep_carb_data$life_habit) #use life_habit to find infauna 
infaunal_lifehabits <- c('deep infaunal', 'infaunal', 'semi-infaunal', 'semi-infaunal, solitary', 'shallow-infaunal',
                         ...
                         'shallow infaunal')
infauna_data <- subset(all_deep_carb_data, life_habit %in% infaunal_lifehabits)
...
epifaunal_data <- subset(all_deep_carb_data, life_habit=='epifaunal')
...
infauna_data <- subset(all_deep_carb_data, genus %in% ecoeng_genera)
...
infaunadom_deep_carb_df <- infaunadom_df
save(infaunadom_deep_carb_df, file='infauna_deep_carbonate_dominance_05-07-2024.RData')
